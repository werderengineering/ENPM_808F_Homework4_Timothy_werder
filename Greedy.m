function [Move,TPMNo,State]=Greedy(AllowedMoves,TPM,UsedNodes,UsedNN,Boxes,Size,MyPoints,EnemyPoints,BoxWalls,State,StateSet,SBSA,QuarterSets,StatePoints,Q,Game,FA)
